...
# Ensure RPC-IF module clock is not gated by clk_disable_unused().
# The OP-TEE W77Q secure storage driver owns the RPC-IF; CONFIG_RENESAS_RPCIF=n
# prevents the Linux driver from loading, but clk_disable_unused() would still
# gate the clock.  clk_ignore_unused prevents that.
